...
<body>
    ...
    <div class="flex-container">
        <div class="section">
            <img class="image-later" style="width: 100%; "
                src="https://pngimg.com/uploads/wikipedia/wikipedia_PNG33.png" alt="">
                <br><br>
            <ul>
        ...
        <div style="margin-bottom: 20px;" class="header">
            ...
            <div class="container-1">
                <div class="flex-container">
                  <div style="margin: 20px;" class="flex-div">
            ...
            <div style="width: 97%;" class="container-2">
                ...
                <textarea style="width: 97%; border-radius: 5px; border: 1px solid #A3BFB1;
                    background-color: #CEF2E0; margin-left: 20px;" rows="5" cols="33"
                    class="p-body">{{$post.Body}}</textarea>
