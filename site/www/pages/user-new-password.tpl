...
{{define "style"}}  <link rel="stylesheet" type="text/css" href="/static/css/new.css" />{{end}}
        ...
        <div class="header">
            ...
            <div style="border: 1px solid #BFA3AF; background-color: #F2CEDD; margin: 20px;" class="flex-container">
                <form style="margin: 20px; font-size: 20px;" action="#" method="post">
                    ...
                    background-color: #FFF5FA;" type="password" class="name" id="password" name="password" autocomplete="off" placeholder="Enter your new password">
                </div><br>
                <div class="up7">
                    <input type="submit" value="Reset" class="next">
                </div>
                </form>
            </div>
        </div>
